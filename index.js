...
const GAME_SPEED_START = 0.6
const GAME_SPEED_INCREMENT = 0.0000001;

const GAME_WIDTH = 800;
const GAME_HEIGHT = 200;
const PLAYER_WIDTH = 89 /1.5;
const PLAYER_HEIGHT = 130 /1.5;
const MAX_JUMP_HEIGHT = GAME_HEIGHT;
const MIN_JUMP_HEIGHT = 150;
const GROUND_WIDTH = 1280;
const GROUND_HEIGHT = 720;
const GROUND_AND_CACTUS_SPEED = 0.6;
const CACTI_CONFIG = [
    {width: 80 / 1.5, height: 80 / 1.5, image: "cactus_1.png" },
    {width: 80 / 1.5, height: 80 / 1.5, image: "cactus_2.png" },
    {width: 80 / 1.5, height: 80 / 1.5, image: "cactus_3.png" },
]
